...
- Updated: 2026-08-03 (rev 169→170: **도커 빌드 & 서비스 배포 UI/UX 디자인 확장 및 원격 main 동기화, PR #60 생성 완료**). `BuildRequest.tsx` 폼 호스팅 필드 확장, `BuildDetail.tsx` 런타임 URL 바로가기 버튼, `AdminHostedServices.css` 스타일링 완료. 원격 `origin/main` (Scalar API Docs) 병합 및 vitest 281개 테스트 ALL PASS. PR #60 생성 및 셀프 리뷰 완료.
