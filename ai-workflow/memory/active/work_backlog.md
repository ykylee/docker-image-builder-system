...
- 상태: stable
- 최종 수정일: 2026-07-03 (rev 24→25: PR #9 squash merge 대기 sync — §27.5 main 합류 섹션 placeholder 추가 (merge commit hash 는 사용자 merge 후 amend). PR #9 의 3 commit (521ccdb ADMIN-* Admin UI / 05a8b56 review nits / 1e2b06e bug fix 2건) 모두 §27/§28 에서 다룸. 회귀 270/270)
