...
- [ ] TASK-060: Build Monitor status model/UI refactor (1차 PR: BuildDetail canonical 4 block + StatusPill lifecycleStatus + legacy preview 분리. 2차 PR: fixture 갱신 + AdminUsers StatusPill 통일. 후속 TASK-060 3차 PR: Admin 라우트 status filter canonical 정렬)
