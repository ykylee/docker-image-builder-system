...
- [ ] TASK-060: Build Monitor status model/UI refactor (1차 PR: BuildDetail canonical 4 block + StatusPill lifecycleStatus + legacy preview 분리. 2차 PR: fixture 갱신 + AdminUsers StatusPill 통일. 3차 PR: status chip filter canonical 정렬. 후속: AdminUsers recent builds panel 을 BuildRow 로 교체)
