...
- **v0.9.0 release candidate 회귀 baseline (2026-08-04)**: 5개 배포 package(`packages/shared-contract`, `packages/shared-config`, `packages/db`, `apps/build-server`, `apps/build-monitor`) version `0.9.0` 통일. frontend Vitest **282/282 PASS**, build-server node:test **205/205 PASS**, TS `--noEmit` clean, runner Go **8 packages PASS**. Helm kind e2e, hosted HTTP kind e2e, ArgoCD kind e2e 모두 PASS. DB/API contract 및 migration 변경은 없음. 상세 검증표와 rollback 기준은 [`RELEASE_NOTES-v0.9.0-2026-08-04.md`](../RELEASE_NOTES-v0.9.0-2026-08-04.md)와 [`CHANGELOG.md`](../CHANGELOG.md)를 따른다.
