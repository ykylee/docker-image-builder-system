...
- Proxy 환경 artifact factory 검토: [`proxy-artifact-factory-2026-08-20.md`](operations/proxy-artifact-factory-2026-08-20.md)는 현재 Docker build의 proxy/cache 미지원 위험과 immutable digest 기반 사전 산출물 경로, credential 비노출 수용 기준을 기록한다. 실제 proxy staging 검증 전에는 운영 경로로 채택하지 않는다.
