...
- Runner 격리/RBAC 전환 기준: [`runner-isolation-rbac-2026-08-20.md`](operations/runner-isolation-rbac-2026-08-20.md)에 host socket 제거, namespace-scoped ServiceAccount/RBAC, NetworkPolicy, rootless BuildKit 전환 순서와 수용 기준을 기록한다. 실제 cluster apply 전에는 production 격리 완료로 간주하지 않는다.
- Proxy 환경 artifact factory 검토: [`proxy-artifact-factory-2026-08-20.md`](operations/proxy-artifact-factory-2026-08-20.md)는 dependency proxy/pull-through cache 요구사항을 기록한다. 상세 구성·manifest·오류·보안·MVP 검증은 [`proxy-artifact-factory-design-2026-08-20.md`](design/proxy-artifact-factory-design-2026-08-20.md)를 따른다. 실제 proxy staging 검증 전에는 운영 경로로 채택하지 않는다.
- Proxy artifact factory 구현 WBS: [`proxy-artifact-factory-wbs-2026-08-20.md`](design/proxy-artifact-factory-wbs-2026-08-20.md)에 M0~M5 milestone, critical path, 산출물과 완료 게이트를 기록한다.
