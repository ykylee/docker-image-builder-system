...
- 상태: stable (v0.8.6 갱신 — v0.6.0 / v0.7.0 종합 RELEASE_NOTES)
- 최종 수정일: 2026-07-25
...
- **MAJOR.MINOR.PATCH** — `v0.8.6` 형식
- **현재 release**: `v0.8.6` (2026-07-25, v0.6.0 / v0.7.0 종합 RELEASE_NOTES)
- **release history**:
...
- **5 package.json 통일 정책**: `apps/build-server` / `apps/build-monitor` / `packages/shared-contract` / `packages/shared-config` / `packages/db` 의 version field 가 모두 동일하게 유지되어야 함. `apps/runner` 는 Go module 이라 version field 없이 git tag 로 버전 관리. 본 release 시점 5/5 `0.8.6` 로 통일.
...
## 2. v0.8.6 (2026-07-25) — v0.6.0 / v0.7.0 종합 RELEASE_NOTES (patch)
...
## 3. v0.8.5 (2026-07-25) — v0.8.0 종합 RELEASE_NOTES (patch)
...
## 4. v0.8.4 (2026-07-25) — PROJECT_PROFILE 신규 운영 가이드 reference + BuildDetail.tsx stale 주석 정합 (patch)
...
## 5. v0.8.3 (2026-07-25) — release-checklist k8s 보강 (patch)
...
## 6. v0.8.2 (2026-07-25) — k8s 운영 가이드 §6.6 보강 (patch)
...
## 7. v0.8.1 (2026-07-25) — k8s e2e nightly CI 편입 (patch)
...
## 8. v0.8.0 (2026-07-25) — k8s adapter 운영 결함 3종 해소 (minor)
...
## 9. v0.7.0 (2026-07-24) — 호스팅 status 캐시 (minor)
...
## 10. v0.6.0 (2026-07-24) — 실패 경로 e2e (minor)
...
## 11. v0.5.1 (2026-07-24) — HTTPS 미도입 확정 (patch)
...
## 12. v0.5.0 (2026-07-24) — subdomain 호스팅 스킴 (minor)
...
## 13. v0.4.1 (2026-07-24) — 호스팅 e2e nightly CI 편입 (patch)
...
## 14. v0.4.0 (2026-07-24) — Phase 3 완료 (호스팅 능력)
...
## 15. v0.3.0 (2026-07-24) — Phase 2 완료 (preview-era 청산 → 배포 능력)
...
## 16. v0.2.1 (2026-07-23) — Phase 1 후속 패치
...
## 17. v0.2.0 (2026-07-22) — Phase 1 완료 baseline
...
## 18. v0.1.0 (2026-07-20) — 백엔드/운영 성숙도 baseline
...
## 19. 회귀 baseline 종합 (TASK-088 → v0.8.6)
...
- `v0.8.7` — patch (회귀 baseline 변경 0 + 운영 가이드/CI 소폭)
